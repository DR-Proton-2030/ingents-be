...
taskRouter.post("/add-task", userAuth_1.userAuth, multer_middleware_1.upload.fields([{ name: "attachments", maxCount: 10 }]), fileUpload_helper_1.fileUploadHelper, task_controller_1.createTask);
